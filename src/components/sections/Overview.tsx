...
// const STATS = [
//   { label: 'Annual Visitors', value: '40M+', icon: '👥' },
//   { label: 'Square Footage', value: '3M',   icon: '📐' },
//   { label: 'Luxury Brands', value: '450+',  icon: '🛍️' },
//   { label: 'From NYC',      value: '8 mi',  icon: '🗽' },
// ];

// // Gemini-powered quick insight generator
// const GEMINI_INSIGHTS = [
//   { q: 'Why is American Dream unique?',       emoji: '✦' },
//   { q: 'What ROI can retail tenants expect?', emoji: '📈' },
//   { q: 'What events have been hosted here?',  emoji: '🎤' },
...
//   return (
//     <section id="overview" className="min-h-screen py-24 flex items-center bg-white">
//       <div className="container mx-auto px-6">
...
//             transition={{ duration: 0.8 }}
//           >
//             <span className="text-blue-600 uppercase tracking-[0.3em] text-xs font-bold block mb-4">
//               The Scale of Ambition
//             </span>
//             <h2 className="text-5xl md:text-7xl font-black mb-8 leading-[0.9] tracking-tighter text-zinc-900">
//               More Than a Mall.<br />
//               <span className="italic text-blue-600">A Global Icon.</span>
//             </h2>
...
//                     <span className="text-4xl md:text-5xl font-black text-blue-600 tracking-tighter">{s.value}</span>
//                   </div>
//                   <span className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">{s.label}</span>
//                 </motion.div>
//               ))}
//             </div>
//           </motion.div>

//           {/* Right — YouTube mall tour */}
//           <motion.div
//             initial={{ opacity: 0, x: 50 }}
//             whileInView={{ opacity: 1, x: 0 }}
//             viewport={{ once: true }}
...
//           >
//             <iframe
//               src="https://www.youtube.com/embed/j3OaC0dXqpI?autoplay=1&mute=1&loop=1&playlist=j3OaC0dXqpI&controls=0&showinfo=0&rel=0&modestbranding=1"
//               className="w-full h-full"
//               allow="autoplay; encrypted-media"
//               allowFullScreen
//               style={{ border: 'none' }}
//               title="American Dream Mall Tour"
//             />
//             <div className="absolute top-4 left-4 flex items-center gap-2 px-4 py-2 rounded-full bg-white/90 backdrop-blur-md shadow">
//               <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
//               <p className="text-[9px] font-black uppercase tracking-[0.25em] text-zinc-900">🎬 Mall Tour</p>
//             </div>
//             <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-zinc-900/80 to-transparent">
//               <p className="text-white text-xs font-black uppercase tracking-wider">American Dream Mall</p>
//               <p className="text-white/60 text-xs">East Rutherford, NJ · 3M sq ft</p>
//             </div>
//           </motion.div>
...
//           {/* Header */}
//           <div className="bg-zinc-950 px-8 py-6 flex items-center gap-4">
//             <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-black text-lg">✦</div>
//             <div>
//               <p className="text-white font-black text-base tracking-tight">AI Insights — Powered by Gemini</p>
//               <p className="text-white/40 text-xs uppercase tracking-widest">Ask anything about the opportunity</p>
//             </div>
//             {!GEMINI_KEY && (
//               <div className="ml-auto px-3 py-1 rounded-full bg-yellow-500/20 border border-yellow-500/30">
//                 <p className="text-yellow-400 text-[9px] font-black uppercase tracking-wider">Demo Mode</p>
//               </div>
//             )}
//           </div>
...
//             {/* Answer area */}
//             <div className="min-h-[80px] p-5 rounded-2xl bg-zinc-50 border border-zinc-100 flex items-center">
//               {loading ? (
...
//                       transition={{ duration:0.8, repeat:Infinity, delay:i*0.15 }} />
//                   ))}
//                   <span className="text-zinc-400 text-sm ml-2">Generating insight...</span>
//                 </div>
//               ) : insight ? (
//                 <motion.p
//                   initial={{ opacity: 0, y: 8 }}
//                   animate={{ opacity: 1, y: 0 }}
//                   className="text-zinc-700 text-base leading-relaxed font-medium"
//                 >
//                   {insight}
//                 </motion.p>
//               ) : (
